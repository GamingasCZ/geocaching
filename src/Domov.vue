    ...
    <main class="mx-auto w-screen max-w-[92rem] ">
        ...
        <div class="flex flex-col justify-center items-start w-full h-screen text-right sm:pr-16">
            ...
            <div
                ...
                <a @focus="currScroll = 2; reposition()" href="https://geocaching.com"
        ...
        <div class="flex flex-col justify-center items-center w-full h-screen text-center sm:pr-16">
            ...
            <div class="flex justify-center w-full">
                <div class="relative">
                    <div
                        class="w-[40rem] relative max-w-[95vw] aspect-[4/3] border-4 rounded-md border-geo-400 overflow-clip">
                        <img :src="fotogalerie[fotkaVybrana - 1]"
                            class="absolute -left-full w-full h-full duration-200 fotka" v-if="fotkaVybrana > 0">
                        <img :src="fotogalerie[fotkaVybrana]" class="absolute left-0 w-full h-full duration-200 fotka">
                        <img :src="fotogalerie[fotkaVybrana + 1]"
                    ...
                    <div
                        class="flex absolute justify-between max-w-[90vw] w-[120%] left-1/2 h-[30rem] items-center -translate-x-1/2 top-0">
                        <button class="w-10 text-3xl rounded-full bg-geo-400 aspect-square"
                            @focus="currScroll = 3; reposition()" @click="posunoutFotku(-1)">&lt;</button>
                        <button class="w-10 text-3xl rounded-full bg-geo-400 aspect-square"
                            @focus="currScroll = 3; reposition()" @click="posunoutFotku(1)">></button>
                    </div>

                    <div class="flex gap-3 justify-center mt-3 mb-[12vh]">
                        <button v-for="dot in maxFotek" @focus="currScroll = 3; reposition()"
