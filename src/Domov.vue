<template>
    <main class="mx-auto max-w-[93rem]">
        <!-- Pozadi -->
        ...
        <div class="my-36 ml-auto w-max text-right">
            ...
            <p class="w-full max-w-[min(36rem,90vw)] text-lg font-medium text-right text-white max-sm:text-sm">
                ...
                <br>Kešky jsou skryty všude a jen čekají na to, než je ulovíte!</p>
            <div class="flex gap-8 justify-around mt-16 max-sm:flex-col">
                <button class="px-16 py-2 text-xl bg-geo-400 skewButton">Jak hrát</button>
                <button class="px-16 py-2 text-xl bg-geo-400 skewButton">O hře</button>
            </div>
        </div>
    </main>
</template>
