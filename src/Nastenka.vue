...
import { hasLocalStorage, handleDrop } from './parserKesek'
...
const vsechnyKesky = reactive<Keska[]>([])
...
<main>
 ...
 <!-- To pak přepni!! -->
 <p v-if="hasLS">Nemáš zaplé místní úložiště/cookies!</p>
 ...
 <section class="bg-gray-500">
    <Keska v-for="(keska) in vsechnyKesky.filter(x => x.section == sloupec)" />
